...
CLI_CLASS_PATH = "scrapers.tjce.scrapper_edge_cli:PJeScraperTJCEEdgeCLI"
MOV_CLASS_PATH = "scrapers.tjce.scrapper_mov_edge_cli:PJeScraperTJCEMovEdgeCLI"
POL_CLASS_PATH = "scrapers.tjce.scraper_polos_edge_cli:PJeScraperTJCEPolosEdgeCLI"
SLUG = "tjce"
DESC_PLANILHAS = "Raspa TJCE (PJe) no Edge e gera planilhas raspada + tratada."
DESC_MOV = "TJCE (PJe) no Edge: exporta só movimentações para Excel."
DESC_POL = "TJCE (PJe, Edge): partes e advogados por polo (Excel)."

"""eSAJ TJSP Edge: após a consulta, extrai só movimentações."""

from __future__ import annotations

import traceback

from scrapers.tjsp.scraper_edge_cli import ESAJScraperTJSPEdgeCLI


class ESAJScraperTJSPMovEdgeCLI(ESAJScraperTJSPEdgeCLI):

"""eSAJ TJAL Edge: após a consulta, extrai só movimentações."""

from __future__ import annotations

import traceback

from scrapers.tjal.scraper_edge_cli import ESAJScraperTJALEdgeCLI


class ESAJScraperTJALMovEdgeCLI(ESAJScraperTJALEdgeCLI):

"""eSAJ TJCE: após a consulta, extrai só movimentações."""

from __future__ import annotations

import traceback

from scrapers.tjce_esaj.scraper_cli import ESAJScraperTJCECLI


class ESAJScraperTJCEMovCLI(ESAJScraperTJCECLI):
